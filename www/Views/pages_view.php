<section class="col-12" style="grid-column: 1/ 13; grid-row: 1;">
    <div class="sectionHeader d-flex">
        <h1 class="titleSection d-flex"><img src=<?php App\Core\View::getAssets("icons/icon_page.png")?> alt="">Liste des pages</h1>
        <h1 id="modalButton" class="searchButtonSection d-flex">Créer<img class="colorSearchButton" src=<?php App\Core\View::getAssets("icons/plus-solid.svg")?> alt="" ></h1>
    </div>
